...
class TapAzScraper:
    ...
    def get_phone_numbers(html: str) -> str:
        """
    ...
    html_snippet = '''<div class="product-shop"><div class="product-phones tz-mt-15"><div class="phone-numbers fixed-height"><div class="show-phones js-show-phones active" data-auth-url="https://tap.az/authentications/new" data-stat="product-call-btn" id="show-phones"><span>Nömrəni göstər</span><span>(055) 762-67-●●</span></div><div class="js-phones"></div><div class="item-warning is-hidden js-item-warning"><span class="item-warning__title">Diqqət!</span><span>&nbsp;</span><span class="item-warning__message">Beh göndərməmişdən öncə sövdələşmənin təhlükəsiz olduğuna əmin olun!</span></div></div></div><div class="tz-mt-15"><div class="chat-write-link" data-is-mobile="false" data-lot-id="42559295" data-stat="" data-user-signed-in="false"><button class="js-chat-btn button chat-message-btn js-chat-btn" data-lot-id="42559295" data-stat="" data-ad-only-messages="false" type="button">Mesaj yaz</button></div></div></div>'''

    partial_phone = extract_partial_phone(html_snippet)
    print(f"Extracted partial phone number: {partial_phone}")
